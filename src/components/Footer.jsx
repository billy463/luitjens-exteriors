        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-400">
              <li>66 Adventura Dr, Festus, MO 63028</li>
              <li>
                <a href="mailto:michaels@luitjens-exteriors.com" className="hover:text-primary transition">
                  michaels@luitjens-exteriors.com
                </a>
              </li>
              <li>
                <a href="tel:+13148820973" className="hover:text-primary transition">
                  (314) 882-0973
                </a>
              </li>
              <li className="pt-2">St. Louis, MO</li>
